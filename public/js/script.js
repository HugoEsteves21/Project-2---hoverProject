...
document.addEventListener("DOMContentLoaded", () => {
  console.log("hoverProject JS imported successfully!");
});
...
/* (function() {
  $(function() {
    ...
    createBubbles = function(bubbleCount) {
      var $bubble, bubbleBlur, bubbleDelay, bubbleOpacity, bubbleScale, bubbleSize, bubbleSpeed, xPos, yPos, _i, _results;
      _results = [];
      for (_i = 0; 0 <= bubbleCount ? _i < bubbleCount : _i > bubbleCount; 0 <= bubbleCount ? _i++ : _i--) {
